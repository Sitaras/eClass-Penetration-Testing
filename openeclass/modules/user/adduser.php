...
if (isset($_POST['search_nom']) || isset($search_prenom) || isset($search_uname)) {
...
if(!isset($search_nom)) $search_nom = ""; else $search_nom = mysql_real_escape_string($purifier->purify($search_nom));
if(!isset($search_prenom)) $search_prenom = ""; else $search_prenom = mysql_real_escape_string($purifier->purify($search_prenom));
if(!isset($search_uname)) $search_uname = ""; else $search_uname = mysql_real_escape_string($purifier->purify($search_uname));

// if(!isset($search_nom)) $search_nom = ""; else $search_nom = mysql_real_escape_string(($search_nom));
// if(!isset($search_prenom)) $search_prenom = ""; else $search_prenom = mysql_real_escape_string(($search_prenom));
// if(!isset($search_uname)) $search_uname = ""; else $search_uname = mysql_real_escape_string(($search_uname));
$tool_content .= <<<tCont
