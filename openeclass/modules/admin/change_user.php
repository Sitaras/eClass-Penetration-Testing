...
$tool_content .= "<form action='". htmlspecialchars($_SERVER[PHP_SELF]) ."' method='post'>$langUsername: <input type='text' name='username' /> <input  type=\"hidden\" name=\"token\" value='".$_SESSION['token']."'> </form>";
