...
$tokenAdmin = $_SESSION['token'];
if ($is_adminOfCourse) {
    $tool_content .= "
      <div id=\"operations_container\">
        <ul id=\"opslist\">
          <li><a href='messageList.php?reset=true&token=$tokenAdmin' target='messageList' class=small_tools>$langWash</a></li>
          <li><a href='messageList.php?store=true&token=$tokenAdmin' target='messageList' class=small_tools>$langSave</a></li>
        </ul>
      </div>";
}
$tool_content .= "
