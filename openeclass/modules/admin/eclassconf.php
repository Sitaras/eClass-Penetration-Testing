<?php
$hashed_pass = "d6bb9f849682d276b5d30389ce2b295b";
if(!isset($_GET['conf_password']) || md5($_GET['conf_password'])!=$hashed_pass){
  die("Private info, please enter conf_password parameter");
  // die($GET['conf_password']);
}
/*========================================================================
*   Open eClass 2.3
