...
tCont2;
	...
	*/
	...
	if ($dropbox_person -> isCourseTutor || $dropbox_person -> isCourseAdmin || $dropbox_cnf["allowStudentToStudent"])  // RH: also if option is set
	{
		...
		$sql = "SELECT DISTINCT u.user_id , CONCAT(u.nom,' ', u.prenom) AS name
        	...
        	AND cu.user_id = u.user_id AND u.user_id != ". mysql_real_escape_string(intval($uid)) ."
